...
class HcwInput extends HTMLElement {
    ...
    constructor() {
        ...
        const raw_props = ['value', 'placeholder', 'disabled', 'type', 'required', 'autocomplete', 'style', 'onchange','readonly'];
        raw_props.forEach(prop => {
            Object.defineProperty(this, prop, {
                get: () => this.#input[prop],
...
class HcwTextarea extends HTMLElement {
    ...
    constructor() {
        ...
        const raw_props = ['value', 'placeholder', 'disabled', 'required', 'style', 'onchange','readonly'];
        raw_props.forEach(prop => {
            Object.defineProperty(this, prop, {
                get: () => this.#input[prop],
                set: (val) => this.#input[prop] = val,
